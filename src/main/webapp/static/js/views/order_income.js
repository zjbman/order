$(function () {
    ...
    $('#table').bootstrapTable({
        url: rootPath + '/orderIncome/List.html',
        method: 'post',   //请求方式（*）
        dataType: "json",
        ...
        columns: [[
            ...
            {field: 'businessName', title: '商家名字', sortable: true},
            {field: 'orderNumber', title: '订单总数', sortable: true},
            {field: 'orderIncome', title: '订单总收入', sortable: true}
        ]],
    }); // 表格结束
