$(function() { 
	...
	$('#table').bootstrapTable({   
		url:rootPath+'/rpt/m_data/m_appstatistic/AppList.html',
		method: 'post',   //请求方式（*）
        dataType: "json",
...
function adstyledetail(){
    ...
    var url=rootPath+"/rpt/m_data/m_appstatistic/getAdstyleDetail.html";
    openDetail(url);
...
function advertdetail(){
    ...
    var url=rootPath+"/rpt/m_data/m_appstatistic/getAdvertDetail.html";
    openDetail(url);
