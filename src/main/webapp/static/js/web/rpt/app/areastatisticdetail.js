$(function() {
	...
	$('#table').bootstrapTable({   
		url:rootPath+'/rpt/app/statistic/AreaDetailList.html',
		method: 'post',   //请求方式（*）
        dataType: "json",
	    ...
	    columns:[[
           /* {field:'ck',checkbox:true },*/
            ...
            {field:'areaname',title:'地区',width:'5%',sortable:true},
	        {field:'activeusercount',title:'活跃用户',width:'4%',sortable:true,footerFormatter: function (rows) {
