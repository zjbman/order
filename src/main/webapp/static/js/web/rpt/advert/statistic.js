$(function() {
    ...
    $('#table').bootstrapTable({
        url:rootPath+'/rpt/advert/statistic/List.html',
        method: 'post',   //请求方式（*）
        dataType: "json",
        ...
        columns:[
            ...
            {field:'advertiserid',title:'广告主id',visible:false,sortable:true,
            ...
            {field:'adtype',title:'广告源',sortable:true,formatter: function(value,row,index){
	        	if(value==1)
	        	{
	        		return "竞价平台";
	        	}
...
//  $table.bootstrapTable('hideColumn', 'advertiserid');
function findadvertdetail(){
    ...
    var url=rootPath+"/rpt/advert/statistic/getAdvertDetail.html";
    openDetail(url);

}
function findsdetail(){
	var url=rootPath+"/rpt/advert/statistic/getSDetail.html";
    openDetail(url);
	
}
function findydetail(){
	var url=rootPath+"/rpt/advert/statistic/getYDetail.html";
    openDetail(url);
}
