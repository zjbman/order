$(function() {
	...
	$('#table').bootstrapTable({
		url:rootPath+'/rpt/advertincome/statistic/DetailList.html',
		method: 'post',   //请求方式（*）
        dataType: "json",
...
//		            {field:'ck',rowspan:2,checkbox:true },
		  	        ...
		  	        {field:'type',title:'广告源',width:'3%',sortable:true,formatter: function(value,row,index){
	                    if(value==1)
	                    {
	                        return "竞价平台";
	                    }
		  	        ...
		  	        {field:'advertname',title:'广告名称',width:'3%',sortable:true},
	                {field:'adstyle',title:'广告类型',width:'3%',sortable:true,formatter: function(value,row,index){
	                if(value==1)
	                {
	                    return "插屏";
	                }
             ...
             {field:'sactivecount',title:'s激活',width:'3%',styler: function (value, row, index) {
                 return ' background-color:FFEEDD;color:black;';
             },sortable:true,footerFormatter: function (rows) {
